---
id: 08-slide-content-en
type: presentation-slides
step: 8
title: "Instant Retail Tier 3-4 City EBIT Breakeven Pathway (Slide Content)"
status: approved
...
**Title | 标题**: Quality Over Quantity, Precision Over Spend — Instant Retail Tier 3-4 City EBIT Breakeven Pathway
**Subtitle | 副标题**: A 3-Year Strategic Roadmap Built on City Focus, Precision Subsidies, and Selective Contraction
...
- 论据（图表）：
  ...
  -140───────────────────────────────►
   ...
   Bleed-Stop  Breakeven  Profit
  ```

---

## Slide 3: Context — Survival Countdown | 背景
...
- 论据（数据卡片）：
  ...
  │  Consumed              Remaining        │
  └────────────────────────────────────────┘
  Annual loss: RMB 135M+  |  Daily burn: ~RMB 370K
  ```
...
- 论据（案例卡片）：
  ...
  ┌─────────────────────────────────┐
  │  C1 Xuzhou                  │
  │  Daily orders: 110,000       │
  │  Annual loss: RMB 25M       │
  │  ─────────────────────        │
  │  Conclusion: Scale alone     │
  │  cannot unlock tier 3-4      │
  │  business model             │
  └─────────────────────────────────┘
  ```
...
- 论据（四宫格）：
  ...
  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐
  │    1    │  │    2    │  │    3    │  │    4    │
  │Breakthrough│ │Core Engine│ │Competitive│ │ Resource  │
  │Solution   │ │          │ │ Escalation│ │Restructuring│
  │  3+3+4   │  │3 Cities, │  │30-Min      │ │Selective   │
  │          │  │3 Playbooks│ │Instant     │ │Contraction │
  └─────────┘  └─────────┘  └─────────┘  └─────────┘
  ```

---

## Slide 4: "3+3+4" Tiered Strategy | 核心建议
...
- 论据（矩阵表格）：
  ```
  ┌──────────────────────────────────────────────────────────┐
  │  Tier           │ Cities           │ Strategy   │ Resource│
  ├─────────────────┼─────────────────┼────────────┼─────────┤
  │ ★ Bleed-Stop   │ Quanzhou/Huizhou│ Year 1     │ +++     │
  │   (3 cities)    │ /Weihai        │ Priority   │ Concentrate│
  ├─────────────────┼─────────────────┼────────────┼─────────┤
  │ → Optimization  │ Xuzhou/Nanchang│ Year 2     │ ++      │
  │   (3 cities)    │ /Nanning       │ Follow-up  │ Subsidy  │
  │                 │                 │           │ Control  │
  ├─────────────────┼─────────────────┼────────────┼─────────┤
  │ ✗ Assessment    │ Guilin/Ganzhou/ │ Asset-light│ -       │
  │   (4 cities)    │ Luoyang/Yichang│           │ Gradual  │
  │                 │                 │           │ Exit     │
  └──────────────────────────────────────────────────────────┘
  ```
...
- 论据（流程图）：
  ```
  4 Tail Cities ──RMB 18.5M Annual Savings──► Bleed-Stop Tier ──► Survive 18-Month Countdown
  ```

---

## Slide 5: Three Cities, Three Playbooks | 三城三路径
...
- 论据（三栏对比表）：
  ```
  ┌──────────────┬──────────────┬──────────────┐
  │   Quanzhou  │   Huizhou    │   Weihai     │
  │ Time-Build  │  Scale-First  │ Category-Mix │
  ├──────────────┼──────────────┼──────────────┤
  │ Hyper 23%  │ 130K orders/  │ AOV RMB 65  │
  │ Supply     │ day           │ High-AOV    │
  │ Chain Depth│ Extreme       │ Structure   │
  │            │ Density       │             │
  ├──────────────┼──────────────┼──────────────┤
  │ Fulfillment │ Fulfillment  │ Fulfillment │
  │ RMB 10.2   │ To optimize  │ RMB 9.0     │
  │ Breakeven  │ Marginally    │ Best UE     │
  │            │ loss-making   │ in portfolio│
  ├──────────────┼──────────────┼──────────────┤
  │ Moat:      │ Moat:        │ Moat:       │
  │ Fresh      │ Infra        │ High-value  │
  │ Repurchase │ Leverage     │ Users 26%   │
  └──────────────┴──────────────┴──────────────┘
  ```
...
## Slide 6: Quanzhou Playbook | 泉州路径
...
- 论据（数据卡片）：
  ...
  ┌─────────────────────────────────┐
  │  Quanzhou C3                 │
  │  Hypermarket share: 23%       │
  │  Fulfillment cost: RMB 10.2   │
...
- 论据（数据卡片）：
  ...
  ┌─────────────────────────────────┐
  │  Huizhou C7                  │
  │  Daily orders: 120,000        │
  │  Status: Marginally loss-making│
  │  Distance to breakeven: Near  │
  └─────────────────────────────────┘
  ```
...
- 论据（数据仪表盘）：
  ...
  │   Portfolio's Best UE          │
  │                                │
  │   AOV: RMB 65    Fulfillment:   │
  │   █════════    █═══════════    │
  │                RMB 9.0        │
  │                                │
  │   High-value user share: 26%  │
  │   ████████████████████        │
  └────────────────────────────────┘
  ```
...
## Slide 9: Subsidy Efficiency Gap | 补贴效率鸿沟
...
- 论据（双柱对比图）：
  ```
    ...
    │ ▓▓▓▓▓▓▓▓▓ │     │ ▓▓▓▓▓▓▓▓▓▓│
    └───────────┘     └───────────┘
    Subsidy/order     Subsidy/order
     RMB 4.9          RMB 3.5

    High retention    High retention
       15%      vs      26%

    ">2x Subsidy Efficiency Gap"
  ```
...
- 论据（饼图）：
  ```
  Subsidy Waste Distribution
  ┌──────────────────────┐
  │ ████████████████    │  80% Low-repeat edge users
  │ ████                │  20% High-value users
  └──────────────────────┘
  ```
...
## Slide 10: Subsidy System Overhaul | 补贴体系切割
...
- 论据（行动清单）：
  ```
  Month 1 Actions (Effective Immediately)
  ┌─────────────────────────────────────┐
  │ • Suspend no-threshold coupons      │
  │   for orders with AOV < RMB 30     │
  │ • Issue "Step-Down Subsidy Plans"  │
  │   for high-loss cities like C1 Xuzhou│
  └─────────────────────────────────────┘
  ```
...
- 论据（流程图）：
  ```
  Month 2-3: Refined Segmentation Model
  ┌─────────────────────────────────┐
  │ Weihai High-Value User Profiles │
  │            ↓                   │
  │ Precision Segmentation Live    │
  │            ↓                   │
  │ Retain Only Top-User Incentives│
  └─────────────────────────────────┘
  ```
...
## Slide 11: Competitive Dynamics Reimagined | 竞争格局重塑
...
- 论据（时间线卡片）：
  ```
  Meituan Strategic Shift
  ┌─────────────────────────────────┐
  │ 2021-2022: RMB 5-7/order dump  │
  │ 2023: "Profitability-first"    │
  │ Current: Subsidy floor reached │
  │         (RMB 2.5-3.5)          │
  │ ─────────────────────────────   │
  │ Conclusion: Threat diminished, │
  │            window opened       │
  └─────────────────────────────────┘
  ```
...
## Slide 12: Differentiation Positioning | 差异化定位
...
- 论据（三栏图）：
  ```
  ┌────────┐┌────────┐┌────────┐
  │Marketing││Fulfillment││Category│
  │        ││        ││        │
  │Urgent/ ││On-Time ││FMCG   │
  │Lazy/   ││Delivery ││Fresh  │
  │Late-night││Promise││Replen.│
  └────────┘└────────┘└────────┘
  ```
...
## Slide 13: Selective Contraction | 选择性收缩
...
- 论据（城市卡片）：
  ...
  Tail City Issues
  ┌─────────────────────────────┐
  │ C10 Ganzhou: Low AOV/Poor UX│
  │ C9  Guilin: Low AOV/Poor UX│
  │ C4  Luoyang: Low AOV/Poor UX│
  │ C5  Yichang: Low AOV/Poor UX│
  │ ────────────────────────── │
  │ Continued infusion = death   │
  └─────────────────────────────┘
  ```
...
- 论据（数据卡片）：
  ```
  ┌─────────────────────────────────┐
  │  Annual Savings: RMB 18.5M     │
  │  Source: 4 Tail Cities         │
...
- 论据（流向图）：
  ```
  4 Tail Cities ──RMB 18.5M──► 3 Core Cities ──► Survive 18-Month Countdown
  ```

---

## Slide 14: Divestiture Paths | 退出路径
...
- 论据（流程图）：
  ```
  Model A: Local Agent Takeover
  ┌─────────────────────────────────┐
  │ Company provides: Brand + System│
  │ Agent absorbs: Fixed costs     │
  │ Goal: Extract residual value    │
  │ Timeline: 2-4 weeks list       │
  │          3-6 months handover   │
  └─────────────────────────────────┘
  ```
...
- 论据（流程图）：
  ```
  Model B: Pure Matchmaking Platform
  ┌─────────────────────────────────┐
  │ Cut: Self-operated logistics    │
  │接入: Third-party logistics      │
  │ Retain: High-margin AOV orders  │
  └─────────────────────────────────┘
  ```
...
- 论据（要点）：
  ```
  Model C: Strategic Evaluation/Partial Exit
  • Contract non-core sites
  • 6-month observation window
  • Protection: Reserved transition subsidies
  ```

---

## Slide 15: 90-Day Quick Wins | 90天快赢
...
- 论据（里程碑卡片）：
  ```
  Year 1: Bleed-Stop Validation
  ┌─────────────────────────────────┐
  │ Goal: 3 Cities EBIT Positive    │
  │ Actions:                        │
  │ • All-in on Quanzhou/Huizhou/   │
  │   Weihai                       │
  │ • C10/C5 Asset-Light Complete  │
  │ Milestone: Bleeding Contained   │
  └─────────────────────────────────┘
  ```
...
- 论据（里程碑卡片）：
  ```
  Year 2: Portfolio Breakeven
  ┌─────────────────────────────────┐
  │ Goal: Portfolio EBIT +RMB 33M  │
  │ Actions:                        │
  │ • Optimization Tier (C1/C2/C6)  │
  │   deployed by city-type         │
  │ • Subsidy compression          │
  │ • AOV elevation                │
  └─────────────────────────────────┘
  ```
...
- 论据（里程碑卡片）：
  ```
  Year 3: Full Profitability
  ┌─────────────────────────────────┐
  │ Goal: 10-City Portfolio Profit  │
  │ Engines:                       │
  │ • AOV +RMB 3.5/year           │
  │ • Subsidy -RMB 0.8/year       │
...
- 论据（时间轴）：
  ...
  Year 1              Year 2              Year 3
  ───────────────────────────────────────────────────────
  Bleed-Stop    →    Breakeven    →    Full Profit
...
- 论据（数据卡）：
  ```
  Engine A: Divestiture Savings
  +RMB 18.5M
  Source: 4 Tail Cities Asset-Light
  ```
...
- 论据（数据卡）：
  ```
  Engine B: Subsidy Efficiency
  +RMB 35M
  Calc: RMB 0.8/order reduction × volume
  ```
...
- 论据（数据卡）：
  ```
  Engine C: AOV Margin Expansion
  +RMB 60M
  Calc: RMB 3.5 AOV increase structural
  ```
...
- 论据（数据卡）：
  ```
  Engine D: Fulfillment Scale Leverage
  +RMB 60M
  Calc: High-priority city density threshold
  ```
...
- 论据（决策卡）：
  ```
  P0 | CSO/Board Ratify "3+3+4" Strategy
  Owner: CSO & Board
  Deadline: Immediate
  Focus: Execution floor through C10/C5
  ```
...
- 论据（决策卡）：
  ```
  P1 | Sign Differentiated KPI Pacts
  Owner: City Teams
  Deadline: Within 90 days
  Action: Re-sign with differentiated metrics
  ```
...
- 论据（决策卡）：
  ```
  P2 | Approve Transition Budget
  Owner: CFO
  Deadline: Within 30 days
  Action: Approve 3-6 month protection budget
  ```
...
- 论据（清单）：
  ```
  Appendix A: 10-City Unit Economics & AOV Cross-Section Data
  Appendix B: Competitive Landscape (High/Med/Low Scenarios)
  Appendix C: Core Financial Assumptions (Sensitivity Matrix)
  Appendix D: Sceptical Review Revision Memo
  ```

**Footer**: Data Source: Internal Financial Estimates | For Internal Use Only
